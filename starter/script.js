const agroTechData = {
  ...
  description: 'Plataforma de agricultura inteligente basada en sensores IoT y análisis predictivo para optimizar cultivos.',
  code: 'AGT-2026-01',
...
const averageEfficiency = crops.reduce(
  (accumulator, crop) => accumulator + crop.efficiency,
  0
) / crops.length;
...
const renderInfo = () => {
  ...
  statsSection.innerHTML = `
    ...
    <p>Índice de productividad: ${stats.productivityIndex}</p>
